...
static X86CPUDefinition builtin_x86_defs[] = {
    {
        ...
        .xlevel = 0x8000000A,
        .model_id = "Intel(R) Core(TM) i5-9600K CPU " QEMU_HW_VERSION,
    },
    {
        .name = "phenom",
        .level = 5,
        ...
        .features[FEAT_SVM] =
            CPUID_SVM_NPT,
        .xlevel = 0x8000001A,
        .model_id = "Intel(R) Core(TM) i5-9600K CPU"
    },
    {
        .name = "core2duo",
        .level = 10,
        ...
        .versions = (X86CPUVersionDefinition[]) {
            { .version = 1 },
            {
                ...
                .props = (PropValue[]) {
                    ...
                    { "rtm", "off" },
                    { "stepping", "1" },
                    { "model-id", "Intel(R) Core(TM) i5-9600K CPU", },
                    { /* end of list */ }
                },
            },
            {
    ...
    },
    {
        ...
        .versions = (X86CPUVersionDefinition[]) {
            ...
            { .version = 3,
              .alias = "Intel(R) Core(TM) i5-9600K CPU",
